...
class PreprocessNode(BaseNode):
    def process(self, ctx: FrameContext) -> FrameContext:
        ...
        # Resize
        if resize := self.config.get("resize"):
        ...
        # Normalize (stores tensor in metadata, frame stays uint8 for downstream drawing)
        ...
        if normalize != "none":
            ...
            if normalize == "0_1":
                ...
                # Assuming RGB order expected by imagenet models
